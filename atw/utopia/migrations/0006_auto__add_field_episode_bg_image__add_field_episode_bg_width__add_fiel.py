...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.bg_image'
        db.add_column(u'utopia_episode', 'bg_image',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Episode.bg_width'
        db.add_column(u'utopia_episode', 'bg_width',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Episode.bg_height'
        db.add_column(u'utopia_episode', 'bg_height',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Episode.bg_track'
        db.add_column(u'utopia_episode', 'bg_track',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.bg_image'
        db.delete_column(u'utopia_episode', 'bg_image')

        # Deleting field 'Episode.bg_width'
        db.delete_column(u'utopia_episode', 'bg_width')

        # Deleting field 'Episode.bg_height'
        db.delete_column(u'utopia_episode', 'bg_height')

        # Deleting field 'Episode.bg_track'
        db.delete_column(u'utopia_episode', 'bg_track')
