...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'utopia_userprofile', 'title',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.age'
        db.add_column(u'utopia_userprofile', 'age',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.skills'
        db.add_column(u'utopia_userprofile', 'skills',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.interests'
        db.add_column(u'utopia_userprofile', 'interests',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.city'
        db.add_column(u'utopia_userprofile', 'city',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.country'
        db.add_column(u'utopia_userprofile', 'country',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=512, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'utopia_userprofile', 'title')

        # Deleting field 'UserProfile.age'
        db.delete_column(u'utopia_userprofile', 'age')

        # Deleting field 'UserProfile.skills'
        db.delete_column(u'utopia_userprofile', 'skills')

        # Deleting field 'UserProfile.interests'
        db.delete_column(u'utopia_userprofile', 'interests')

        # Deleting field 'UserProfile.city'
        db.delete_column(u'utopia_userprofile', 'city')

        # Deleting field 'UserProfile.country'
        db.delete_column(u'utopia_userprofile', 'country')
