...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'utopia_userprofile', 'description')

        # Adding field 'UserProfile.languages'
        db.add_column(u'utopia_userprofile', 'languages',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'utopia_userprofile', 'description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.languages'
        db.delete_column(u'utopia_userprofile', 'languages')
